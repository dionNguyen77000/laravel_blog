...
@section('styles')
    <link rel="stylsheet" href="https://maxcdn.bootstapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
        ...
        <section id="category-admin">
            ...
            <form action="" method="post">
                <div class="input-group">
                    ...
                    <button type="submit" value="create category" class="btn">Create Category</button>
                </div>
            </form>
        </section>
        <section class="list">
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{URL::to('src/js/categories.js')}}">
